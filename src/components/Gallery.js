...
function Gallery() {
  return (
    <div className="row gap-5 justify-content-center text-center mx-auto">
      <Project name="User dashboard" description="CRUD app using Redux Toolkit and Firebase" repo="redux" />
      <Project name="English dictionary" description="Dictionary based on a public API" repo="dictionary" />
      <Project name="Expenses chart" description="Weekly expenses chart with dynamic data" repo="expenses" />
    </div>
  );
}

function Project({ name, description, repo }) {
  return (
