    ...
    <div className="col-xl-6 col-lg-7 col-md-11 text-xl-justify mt-5 mt-lg-0 px-4 px-xl-2">
      ...
      <p>
        ...
        <span className="d-block mt-3 d-sm-inline mt-sm-0">
          I had the chance to study an associate's degree on networks and security, a degree which I had always seen as
        ...
        <span className="d-block my-3 d-sm-none">
          Fast forward a couple of months and I'm catching up with a good friend, whom during our conversation mentions
          his new job and what he does as a developer now.
        </span>
      </p>
      <p className="d-none d-sm-block">
        However as time went on, I realized some of my career goals had shifted and I started thinking about what I
        wanted to achieve next. Fast forward a couple of months and I'm catching up with a good friend, whom during our
        conversation mentions his new job and what he does as a developer now.
      </p>
      <p className="mb-0">
