    ...
    <main className="row gap-5 justify-content-evenly overflow-hidden mx-auto flex-shrink-0 my-5">
      <div className="row gap-5 justify-content-center justify-content-lg-evenly justify-content-xl-center align-items-center text-center mx-auto">
        ...
        <div className="col-xl-6 col-lg-7 col-md-11 text-xl-justify px-4 px-xl-2">
          ...
          <p>
            Great question! So I've always been interested in computers and tech
            overall, in understanding how things work and learning new stuff.{" "}
            <br className="d-sm-none" />
            <span className="d-block mt-3 d-sm-inline mt-sm-0">
              I had the chance to study an associate's degree on networks and
              security, a degree which I had always seen as my dream career
              path.
            </span>
            <span className="d-block my-3 d-sm-none">
              However as time went on, I realized some of my career goals had
              shifted and I started thinking about what I wanted to achieve
              next.
            </span>
            <span className="d-block my-3 d-sm-none">
              Fast forward a couple of months and I'm catching up with a good
              friend, whom during our conversation mentions his new job and what
              he does as a developer now.
            </span>
          </p>
          <p className="d-none d-sm-block">
            However as time went on, I realized some of my career goals had
            shifted and I started thinking about what I wanted to achieve next.
            Fast forward a couple of months and I'm catching up with a good
            friend, whom during our conversation mentions his new job and what
            he does as a developer now.
          </p>
          <p className="mb-0">
            I was definitely drawn and felt what he said resonated a lot with my
            interests, so once home I went online and started reading more about
            it.{" "}
            <span className="d-block mt-3 d-sm-inline mt-sm-0">
              My journey to become a web developer started since, and this
              website is a way to show myself and others what I've accomplished
              so far.
            </span>
          </p>
        </div>
